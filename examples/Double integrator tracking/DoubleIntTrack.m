%% Problem formulation
function [problem] = DoubleIntTrack
% Double integrator based sinusiodal tracking problem
%
% Syntax:  [problem] = DoubleIntTrack
%
% Outputs:
...
problem.inputs.u0l = -U_limit;
problem.inputs.u0u = U_limit;
